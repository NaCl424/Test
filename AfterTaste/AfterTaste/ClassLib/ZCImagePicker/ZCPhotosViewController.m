...
-(void)loadContentViews
{
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"完成" style:UIBarButtonItemStylePlain target:self action:@selector(finishDone)];
...
{
    self.bottomContainer =[[UIView alloc] initWithFrame:CGRectMake(0, self.view.bounds.size.height - 40, self.view.bounds.size.width, 40)];
    self.bottomContainer.backgroundColor = [UIColor blackColor];
    self.bottomContainer.alpha = 0.8;
...
//    UIButton *finishBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.bounds.size.width-110, 4, 100, 30)];
